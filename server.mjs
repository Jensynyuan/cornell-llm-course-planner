...
async function fetchExternalText(url, { headers = {}, accept = "application/json,text/plain;q=0.9,*/*;q=0.5", timeout = 25_000 } = {}) {
  ...
  try {
    const response = await fetch(parsed, {
      headers:{ Accept:accept, "User-Agent":"Cornell-LLM-Course-Planner-v5.32", ...safeHeaders },
...
server.listen(PORT,"127.0.0.1",()=>console.log(`Cornell LL.M. Course Planner v5.32: http://127.0.0.1:${PORT}`));
